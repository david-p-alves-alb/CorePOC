...
import com.alticelabs.api.IReadWriteRepository;
...
import com.alticelabs.repository.R01.ReadWriteRepository;

import java.util.List;
import java.util.Optional;

public class TCReadWriteRepository<T extends ExagonEntity,S extends ExagonEntityEvent> implements IReadWriteRepository<T,S> {
    private final ReadWriteRepository<TCEntityAdapter<? extends T>,TCEntityEventAdapter<? extends S>> repository;

    public TCReadWriteRepository(Class<T> entityClass, Class<S> eventClass) {
        ...
        this.repository = new ReadWriteRepository<>(new TCDatasourceAdapter(readWriteSnapshotDatasource),
