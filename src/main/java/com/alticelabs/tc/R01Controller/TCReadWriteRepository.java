...
import com.alticelabs.repo_external_api.IReadWriteRepository;
...
public class TCReadWriteRepository<T extends Entity,S extends EntityEvent> implements IReadWriteRepository<T,S> {
    private final ReadWriteRepository<T,S> repository;
